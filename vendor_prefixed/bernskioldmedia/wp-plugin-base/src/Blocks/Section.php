 ...
 * Section
 */
namespace ECLW_Vendor\BernskioldMedia\WP\PluginBase\Blocks;
...
abstract class Section extends Block
{
     ...
     */
    protected static array $section_attributes = ['align' => ['type' => 'string', 'default' => 'full'], 'anchor' => ['type' => 'string'], 'sectionWrapperEnabled' => ['type' => 'boolean', 'default' => \true], 'backgroundImageId' => ['type' => 'string'], 'backgroundImageUrl' => ['type' => 'string'], 'backgroundImageFocalPoint' => ['type' => 'object', 'default' => ['x' => 0.5, 'y' => 0.5]], 'backgroundImageDimensions' => ['type' => 'object', 'default' => ['width' => 0, 'height' => 0]], 'isSectionFullHeight' => ['type' => 'boolean', 'default' => \false], 'sectionContentWidth' => ['type' => 'string', 'default' => 'page-width'], 'sectionVerticalSpacing' => ['type' => 'string', 'default' => 'normal'], 'sectionHeaderShow' => ['type' => 'boolean', 'default' => \false], 'sectionHeaderStyle' => ['type' => 'text', 'default' => 'normal'], 'sectionEyebrow' => ['type' => 'string'], 'sectionTitle' => ['type' => 'string'], 'sectionSubtitle' => ['type' => 'string'], 'sectionCtaShow' => ['type' => 'boolean', 'default' => \false], 'sectionCtaText' => ['type' => 'string'], 'sectionCtaLink' => ['type' => 'string'], 'sectionFooterShow' => ['type' => 'boolean', 'default' => \false], 'sectionFooterAlignment' => ['type' => 'string', 'default' => 'center'], 'sectionFooterText' => ['type' => 'string'], 'sectionFooterCtaShow' => ['type' => 'boolean', 'default' => \false], 'sectionFooterCtaText' => ['type' => 'string'], 'sectionFooterCtaLink' => ['type' => 'string']];
    /**
     ...
     */
    protected static abstract function content(array $attributes) : void;
    /**
    ...
    protected static function render_section_header(array $attributes) : void
    {
        ...
        if ($section_cta_show) {
            ...
            echo esc_url(static::get_attr_value($attributes, 'sectionCtaLink'));
            ?>"><?php 
            echo esc_html(static::get_attr_value($attributes, 'sectionCtaText'));
            ?></a>
				</p>
			<?php 
        }
    ...
    protected static function render_section_footer(array $attributes) : void
    {
        ...
        if ($section_footer_cta_show) {
            ...
            echo esc_url(static::get_attr_value($attributes, 'sectionFooterCtaLink'));
            ?>"><?php 
            echo esc_html(static::get_attr_value($attributes, 'sectionFooterCtaText'));
            ?></a>
					</div>
				<?php 
        }
