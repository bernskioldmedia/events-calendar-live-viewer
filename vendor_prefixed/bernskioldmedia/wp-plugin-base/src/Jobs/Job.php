...
namespace ECLW_Vendor\BernskioldMedia\WP\PluginBase\Jobs;
...
abstract class Job extends WP_Async_Request
{
    ...
    public function schedule_cron_healthcheck($schedules)
    {
        ...
        $schedules[$this->identifier . '_cron_interval'] = ['interval' => MINUTE_IN_SECONDS * $interval, 'display' => \sprintf(__('Every %d Minutes', 'eq-master'), $interval)];
        return $schedules;
    }
    /**
