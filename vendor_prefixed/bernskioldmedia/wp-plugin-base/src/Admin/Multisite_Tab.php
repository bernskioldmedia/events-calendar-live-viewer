...
namespace ECLW_Vendor\BernskioldMedia\WP\PluginBase\Admin;

use ECLW_Vendor\BernskioldMedia\WP\PluginBase\Interfaces\Hookable;
/**
 * Class Multisite_Tab
 *
...
abstract class Multisite_Tab implements Hookable
{
    ...
    protected static abstract function get_title() : string;
    public static abstract function notice() : void;
    public static abstract function save(\ECLW_Vendor\WP_Site $site, $request_data) : void;
    ...
    public static function handle_save() : void
    {
        ...
        wp_redirect(add_query_arg(['page' => static::$slug, 'id' => $site_id, 'updated' => \true], esc_url(network_admin_url('sites.php'))));
        exit;
    }
    /**
     * Add Menu Page
    ...
    {
        $tabs[static::$slug] = ['label' => static::get_title(), 'url' => 'sites.php?page=' . static::$slug, 'cap' => static::$capability];
        return $tabs;
    }
    /**
     ...
     * @return \WP_Site|null
     */
    protected static function get_site_from_request() : ?\ECLW_Vendor\WP_Site
    {
        $id = (int) $_REQUEST['id'];
        if (!$id) {
            return null;
