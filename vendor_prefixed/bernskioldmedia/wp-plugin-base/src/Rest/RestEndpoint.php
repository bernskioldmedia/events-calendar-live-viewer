 ...
 * @since   1.0.0
 */
namespace ECLW_Vendor\BernskioldMedia\WP\PluginBase\Rest;

use ECLW_Vendor\BernskioldMedia\WP\PluginBase\Interfaces\RestEndpointInterface;
...
abstract class RestEndpoint extends \WP_REST_Controller implements RestEndpointInterface
{
     ...
     * Namespace
     */
    protected $namespace = 'events_calendar_live_viewer';
    /**
     * Version
     */
     ...
     */
    protected function get_filter_value(\ECLW_Vendor\WP_REST_Request $request, string $key) : ?string
    {
