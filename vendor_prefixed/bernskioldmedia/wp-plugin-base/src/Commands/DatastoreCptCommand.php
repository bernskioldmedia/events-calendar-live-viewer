...
use ECLW_Vendor\BernskioldMedia\WP\PluginBase\Inflect;
...
class DatastoreCptCommand extends MakeCommand
{
    ...
    {
        parent::configure();
        $this->addOption('namespace', 's', InputOption::VALUE_OPTIONAL, 'The root plugin namespace.', 'NAMESPACE')->addOption('textdomain', 't', InputOption::VALUE_OPTIONAL, 'The plugin textdomain.', 'events-calendar-live-viewer');
    }
