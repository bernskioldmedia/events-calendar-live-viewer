...
use ECLW_Vendor\Symfony\Component\Console\Command\Command;
...
use ECLW_Vendor\Symfony\Component\Process\Process;
class SetupBlocksCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $npmDeps = ['@bernskioldmedia/wp-editor-components', '@wordpress/block-editor', '@wordpress/blocks', '@wordpress/components', '@wordpress/compose', '@wordpress/data', '@wordpress/element', '@wordpress/i18n'];
        $npmDevDeps = ['@wordpress/eslint-plugin', '@wordpress/scripts', 'copy-webpack-plugin', 'fast-glob', 'path', 'replace-in-file-webpack-plugin', 'webpackbar'];
