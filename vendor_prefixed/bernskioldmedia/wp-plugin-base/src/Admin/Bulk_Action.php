...
abstract class Bulk_Action implements Hookable
{
    ...
    protected static abstract function process(int $object_id) : void;
    ...
    public static function show_notice() : void
    {
		...
		<div id="message" class="updated notice is-dismissable">
			<p><?php 
        echo static::get_success_message((int) $_REQUEST[$query_var]);
        // @codingStandardsIgnoreLine
        ?></p>
		</div>
		<?php 
    }
    protected static abstract function get_success_message(int $count) : string;
    protected static abstract function get_name() : string;
}
